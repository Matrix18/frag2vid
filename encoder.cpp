...
static void frameRGBtoYUV(uint8_t *rgb) {
    ...
    sws_context = sws_getCachedContext(sws_context,
	    c->width, c->height, AV_PIX_FMT_BGR32,   //storage endian specific? comparable options AV_PIX_FMT_RGB32, AV_PIX_FMT_RGB32_1
...
void encodeFrame(uint8_t *rgb) {
    ...
    //ffmpeg_encoder_set_frame_yuv_from_rgb
    frameRGBtoYUV(rgb);
    av_init_packet(&pkt);
    pkt.data = NULL;
    pkt.size = 0;
